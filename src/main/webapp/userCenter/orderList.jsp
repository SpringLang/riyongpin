...
<body>
	...
	<div class="manage">
		<div class="search">
			<form action="${pageContext.request.contextPath}/order/findOrder.do" method="post">
		...
		<table class="list">
			<c:forEach var="order" items="${orderList }">
				...
				<c:forEach var="orderProduct" items="${order.orderProductList }">
					<tr>
						<td width="50%"><a
							href="${pageContext.request.contextPath}/product/showProduct/${orderProduct.product.id }.do"
