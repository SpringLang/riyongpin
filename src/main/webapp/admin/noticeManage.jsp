...
<script type="text/javascript">
	...
	function openNoticeAddDialog(){
		...
		url="${pageContext.request.contextPath}/notice/saveorupdate.do";
	}
	...
	function openNoticeModifyDialog(){
		...
		url="${pageContext.request.contextPath}/notice/saveorupdate.do?id="+row.id;
	}
...
<body style="margin: 1px;">
	<table id="dg" title="公告管理" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/notice/list.do"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
