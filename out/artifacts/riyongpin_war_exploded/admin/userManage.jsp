...
<script type="text/javascript">
	...
	function openUserModifyDialog(){
		...
		url="${pageContext.request.contextPath}/user/saveUser.do?id="+row.id;
	}
...
<body style="margin: 1px;">
	<table id="dg" title="用户管理" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/user/list.do" fit="true"
		toolbar="#tb">
		<thead>
			<tr>
			...
			<table cellspacing="8px">
				...
				<tr>
					...
					<td><input type="text" id="dentityCode"
						name="dentityCode" class="easyui-validatebox" required="true" /></td>
				</tr>
				<tr>
					<td>邮件：</td>
