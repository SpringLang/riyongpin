...
<script type="text/javascript">
	...
	function modifyOrderStatus(status){
		...
		$.messager.confirm("系统提示","您确认要处理这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/order/modifyOrderStatus.do",{orderNos:orderNos,status:status},function(result){
					if(result.success){
...
<body style="margin: 1px;">
	<table id="dg" title="订单管理" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/order/list.do" fit="true"
		toolbar="#tb">
		<thead>
			<tr>
...
<%--				<th field="createTime" width="100" align="center">创建时间</th>--%>
	...
	<div id="dlg" class="easyui-dialog"
		...
		<table id="dg2" title="订单商品列表" class="easyui-datagrid"
			...
			url="${pageContext.request.contextPath}/order/findProductListByOrderId.do" fit="true">
			<thead>
				<tr>
					<th field="cb" checkbox="true" align="center"></th>
