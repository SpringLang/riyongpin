...
<script type="text/javascript">
	...
	function searchNews(){
		$("#dg").datagrid('load',{
			"title":$("#s_newsTitle").val()
		});
	}
	
	function openNewsAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加新闻信息");
		url="${pageContext.request.contextPath}/news/saveorupdate.do";
	}
	...
	function openNewsModifyDialog(){
		...
		url="${pageContext.request.contextPath}/news/saveorupdate.do?id="+row.id;
	}
...
<body style="margin: 1px;">
	<table id="dg" title="新闻管理" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/news/list.do" fit="true"
		toolbar="#tb">
		<thead>
			<tr>
			...
			<table cellspacing="8px">
				<tr>
					...
					<td colspan="4"><input type="text" id="title"
						name="title" class="easyui-validatebox" required="true"
